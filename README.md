...
## Descripción
Este proyecto fue creado para el ciclo formativo como trabajo para poner a prueba todos los conociminetos adquiridos en HTML y CSS, creando una adaptación de portfolio en formato web mostrando mis aptitudes, trabajo y contacto.
